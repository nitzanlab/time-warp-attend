...
topo_num_to_str_dict = {
    ...
    topo_ghost: 'ghost',
    topo_attractor: 'attractor point',
    topo_saddle: 'saddle point',
    topo_repeller: 'repeller point',
    topo_attr_spiral:  'spiral to attractor point',
    topo_rep_spiral:  'spiral from repeller point',
    topo_degenerate: 'degenerate',
    topo_center: 'centers',
    topo_line: 'lines',
    topo_period_attr: 'attracting periodic orbit', 
